...
<head>
  ...
  <title>Customer Module | Dashboard</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar smooth-scroll">
    ...
    <section class="sidebar">
      ...
      <!-- search form -->
      <form action="pages/results.php" method="post" class="sidebar-form">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="pages/cooking.php"><span>Cooking</span></a>
        </li>
        <li class="treeview">
          <a href="pages/design.php"><span>Design</span></a>
        </li>
        <li class="treeview">
