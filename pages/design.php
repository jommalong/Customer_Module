...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content-header">
        <h1 style="font-size: 50px">Design</h1>
    </section>

    <section class="content">
      <div id="design">
      <p>Design is about progress. It is the conceptualization and creation of new things. Designers imagine and make. They also research and think. Skilled in one or more specialties of the discipline, designers use their abilities in collaboration with others. Designers want to make ideas real and to make a difference.</p>
      <div class="row">
